...
class DeepQNetwork(object):
    def __init__(self, lr, n_actions, name, fc1_dim=30, fc2_dim=20, fc3_dim=10, input_dim=(20,), chkpt_dir='./dqn'):
        self.lr = lr
    ...
    def save_to_pb(self): # Speichern des Funktionsapproximators für die Integration in die Auftragsagenten
        ...
        model_file = model_file = os.path.abspath(os.path.join(os.path.dirname( __file__ ), 'function_approximator/saved_network.pb'))
...
class Agent(object):
    def __init__(self, alpha, gamma, mem_size, n_actions, batch_size, replace_target=10, input_dim=(11,),
        ...
        self.logname = 'losslog_alpha=' + str(alpha) +'.csv'
